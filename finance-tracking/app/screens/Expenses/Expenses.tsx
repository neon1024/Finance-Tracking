    ...
    return (
        <ScrollView contentContainerStyle={styles.scrollContainer}>
            ...
            >
                <View style={addExpenseModalStyles.overlay}>
                    <View style={addExpenseModalStyles.container}>
                        <View
                            style={addExpenseModalStyles.closeButtonContainer}
                        >
                            <TouchableOpacity
                            ...
                            >
                                <Octicons name={"x"} size={24} color="cyan" />
                            </TouchableOpacity>
                        </View>

                        <View style={addExpenseModalStyles.formContainer}>
                            <View>
                                <Text style={addExpenseModalStyles.titleText}>
                                    Add Expense
                                </Text>
                            </View>
                        ...
                        <TouchableOpacity
                            ...
                            onPress={() => addExpense()}
                        >
                            <Text style={addExpenseModalStyles.addButtonText}>
                                Add
                            </Text>
                        </TouchableOpacity>
                    </View>
            ...
            <View style={expensesStyles.container}>
                <View style={expensesStyles.deleteAndViewAllButtonsContainer}>
                    <TouchableOpacity
